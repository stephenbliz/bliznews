    ...
    return(
        <section>
            ...
            >
                ...
                Saturday afternoon in a slack-jawed fanboy recitation of his 
                greatest hits. Oh, my God, you're Jake LaMotta! You're Johnny 
                Boy! You're Travis Bickle! I'm talking to you.
            </p>
            <p
                className="mb-4"
            >
                You forget your dreams, ignore your family, suppress your feelings,
                neglect your friends, and forget to be happy. Errors of omission 
                are a particularly dangerous type of mistake, because you make 
                them by default.
            </p>
            <p
                className=""
            >
                ...
                Fockers franchise. And as the reliable heavy in a steady 
                stream of action movies and crime dramas, some but not all 
                of them quite good. It has become fashionable to suggest 
                that De Niro's best work is behind him. But nostalgia is a vice, 
                and a survey of the last four decades of movie history reveals 
                that De Niro has never slackened, diminished or gone away but 
                has rather, year in and year out, amassed a body of work marked
                by a seriousness and attention to detail that was there from the 
                start.
            </p>
        </section>
    )
