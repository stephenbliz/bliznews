...
export default function Header(){
    ...
    return(
        <header
            className="fixed top-0 left-0 w-[100vw] h-fit border-b border-gray-300"
        >
            <nav
                className="h-[7rem] lg:h[5rem] bg-red-600 px-[1rem] text-white sm:px-[4rem] flex items-center justify-between"
            >
                <div
                            ...
                            >
                                {
                                    medias.map((media)=>(
                                        <Link
                                            href='#'
                                            className={`flex items-center gap-2 p-4 w-[22vw] mx-1 border-b border-gray-300  text-gray-400 hover:text-[var(--hover-colour)] transition duration-300 ease-linear`}
                                            key={media.id}
            ...
            <nav
                className="h-[5rem] hidden lg:flex px-[4rem]"
            >
